...
<body>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbar-links">
              <div class="navbar-nav mx-auto">
               ...
               <div class="navbar-nav">
                    <a href="#" class="nav-item nav-link" id="acess-menu">Login/Registrar</a>
                </div>
            </div>
        </nav>
    </div>
    <div>
        <div class="d-flex flex-column align-items-center justify-content-center h-100">
            <div class="login-content" style="background-color: white; padding: 10rem;">
                <div class="login-title">
                    <h1>Olá<br>Seja bem-vindo de volta!</h1>
                    <p style="font: 18px bold; font-family: 'Roboto', sans-serif;">Faça seu login</p>
                </div>
                <form>
                    <div class="mb-3">
                    ...
                    <div>
                        <p>Não possui uma conta? <a href="./register-page.php">Registre-se</a> agora mesmo!</p>
                    </div>
                </form>
            </div>
        </div>
